...
void AddBackgroundBlur(ImDrawList* draw_list, IDXGISwapChain* swap_chain, ID3D11Device* _device, ID3D11DeviceContext* _ctx, ImVec2 start, ImVec2 end, float rounding = 0.0f, ImDrawFlags flags = 0) {
